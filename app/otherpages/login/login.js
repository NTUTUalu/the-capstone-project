...
<div className="right flex flex-col h-full bg-amber-2 bg-pink-600 w-full">

<div className="middle flex justify-center items-center bg-amber-4 h-full  w-full bg-pink-800">
