    ...
    return (
        ...
        <div className="bg-pink-3 flex px-10 pt-7 pb-5 h-fit border-b border-slate-300">
            <div className="bg-blue-3 w-full flex">
                ...
                <h1 className="font-semibold tracking-wide border-2 border-slate-500 border-solid px-1">POULTRY PLUS<span className="ml-0.5"><sup>+</sup></span></h1>
                    <div className="Navlinks bg-pink-4 w-full mt-5 flex justify-center items-center text-base tracking-wider">
                    <Link href="/" className=" mr-4 max-md:mr-3">   HOME </Link>
