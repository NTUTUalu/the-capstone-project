...
export default function Productdescription() {
  ...
  <h4>Availability : <span className="text-amber-500 font-normal">In Stock</span></h4>
          <p className="w-1/2 text-slate-500 font-normal mb-6 max-md:w-5/6 max-md:font-semibold max-sm:w-full">
          Poultry Plus, where farm-fresh goodness meets swift delivery! 🚚🥚 Explore a world of quality eggs and farm produce, delivered to your doorstep in a heartbeat. 🌐🍳 #PoultryPlusDelivers #FarmToDoorPerfection
          </p>
          <Link
            href="/"
      ...
      <div className="h-full w-full px-40 bg-pink-3 my-20">
        ...
        <div className=" bg-amber-8 flex flex-col w-full px">
          <h1 className='w-full bg-blue-3 text-center mt-8 mb-1 text-lg tracking-wide font-semibold'>Find A Suitable Supplier</h1>
          <p className='w-full bg-blue-3 text-slate-600 text-center text-xs mb-8 tracking-wide '>Suppliers listed below are mass suppliers of all products listed on the home page and fees are <br/>based on deliveries around Kigali Province</p>
