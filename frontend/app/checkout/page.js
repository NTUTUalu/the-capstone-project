      ...
      <div className="wrapper flex w-full bg-blue-5 h-fit min-h-screen">
        <div className="right flex flex-col h-full bg-amber-2 bg-pink-6 w-full">
          <div className="middle flex justify-center items-center bg-amber-4 h-full  w-full bg-pink-8">
            <div className="grid grid-cols-1 gap-8 w-full mx-52 justify-items-center rounded-3xl min-w-72 bg-yellow-900 my-10 p-4 pb-10 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-7">
              
                <div className="grid grid-cols-2 grid-row-1 gap-4 p-5 bg-yellow-0 w-full h-60 rounded-3xl border-4 border-yellow-200">
<div className="flex flex-col p-4 bg-pink-1 border-r-2 border-yellow-200 ">
<h4 className="text-slate-400 font-medium mb-1 text-lg">WHITE EGGS</h4> 
<h4 className="text-slate-400 font- mb-1">Quantity: 22</h4> 
<h4 className="text-slate-400 font- mb-1">Province: Mpumalanga</h4> 
<h4 className="text-slate-400 font- mb-1">Supplier Name: JJ Suppliers</h4> 
</div>
<div className=" bg-blue-1 position-relative">
    <div className=" flex justify-center w-full h-full items-center position-relative bg-red-2">
            ...
            />   </div>        
                ...
                <div className="grid grid-cols-2 grid-row-1 gap-4 p-5 bg-yellow- w-full h-56 rounded-3xl border-4 border-yellow-100 ">
...
<div className="relative mb-6 text-sm ">
                ...
                <button
                  type="submit"
                  className="inline-block w-64 rounded-3xl mb-2 bg-amber-400 px-6 pb-2 pt-2.5 text-sm tracking-wider uppercase leading-normal text-yellow-800 font-semibold transition duration-150 ease-in-out hover:bg-amber-400 "
                >
                  Proceed to payment
                </button>
            </div>
